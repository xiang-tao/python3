...
namespace dolfin
{
  class dolfin_expression_dc91fc35665e27019c899e7ee3073785 : public Expression
  {
     public:
...
double px_p;
       ...
       dolfin_expression_dc91fc35665e27019c899e7ee3073785()
       {
       ...
       void eval(Eigen::Ref<Eigen::VectorXd> values, Eigen::Ref<const Eigen::VectorXd> x) const override
       {
          ...
          values[0] = r0*r0*(rho*r0*x[0]*ppp+3*f*p*p/r0*px_p);

       }

       void set_property(std::string name, double _value) override
       {
          if (name == "r0") { r0 = _value; return; }          if (name == "px_p") { px_p = _value; return; }
       throw std::runtime_error("No such property");
       }

       double get_property(std::string name) const override
       {
          if (name == "r0") return r0;          if (name == "px_p") return px_p;
       throw std::runtime_error("No such property");
       return 0.0;
       }
...
extern "C" DLL_EXPORT dolfin::Expression * create_dolfin_expression_dc91fc35665e27019c899e7ee3073785()
{
  return new dolfin::dolfin_expression_dc91fc35665e27019c899e7ee3073785;
}
