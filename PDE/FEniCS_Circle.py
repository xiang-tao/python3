...
p = dolfin.Expression("x[0]+x[1]",degree=1)
a = p*dolfin.inner(dolfin.nabla_grad(u),dolfin.nabla_grad(v))*dolfin.dx
f2 = dolfin.Expression("6*(x[0]+x[1])", degree=1)
L2 = f2*v*dolfin.dx
...
cp = dolfin.plot(u_sol2,cmap=cm.rainbow)
